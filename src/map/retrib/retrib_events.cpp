...
std::vector<std::vector<uint8>> Tasks =
{
    ...
    {Retrib::Stat::STAT_MINING,      Retrib::Stat::STAT_LOGGING,  Retrib::Stat::STAT_HARVESTING, Retrib::Stat::STAT_EXCAVATING, Retrib::Stat::STAT_PVP},
    {Retrib::Stat::STAT_QUEST,       Retrib::Stat::STAT_MISSION,  Retrib::Stat::STAT_PVP},
    {Retrib::Stat::STAT_NQ_SYNTH,    Retrib::Stat::STAT_HQ_SYNTH, Retrib::Stat::STAT_PVP}, //Retrib::Stat::STAT_ENHANCEMENT
    {Retrib::Stat::STAT_MOB_KILL,    Retrib::Stat::STAT_NM_KILL,  Retrib::Stat::STAT_PVP},
    {Retrib::Stat::STAT_VALOR,       Retrib::Stat::STAT_PVP},
    {Retrib::Stat::STAT_EXPERIENCE,  Retrib::Stat::STAT_PVP}
};

std::vector<std::vector<std::string>> TaskTexts =
{
    {"Win BCNMs and Battlefield Events", "Gain PVP Victories"},
    {"Mine Materials", "Log Materials", "Harvest Materials", "Excavate Materials", "Gain PVP Victories"},
    {"Complete Quests", "Complete Missions", "Gain PVP Victories"},
    {"Create Normal-Quality Items", "Create High-Quality Items", "Gain PVP Victories"}, //"Enhance Gear"
    {"Kill Experience-Granting Mobs", "Kill NMs", "Gain PVP Victories"},
    {"Complete Regimes (FoV and GoV)", "Gain PVP Victories"},
    {"Gain Experience Points", "Gain PVP Victories"}
};

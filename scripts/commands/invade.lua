...
local p_loc_coord =
{
    [1]		=	{x =   22,   y = 0,  z =   0,   rot = 128,  zone = 71},
    [2]		=	{x = -568,   y = 0,  z =  16,   rot = 191,  zone = 71},
    [3]		=	{x = -488,   y = 0,  z = -16,   rot =  65,  zone = 71},
    [4]		=	{x = -488,   y = 0,  z =  15,   rot = 192,  zone = 71},
    [5]		=	{x = -567,   y = 0,  z = -15,   rot =  63,  zone = 71},
}

local t_loc_coord =
{
    [1]		=	{x =  -24,   y = 0,  z =   0,   rot =   1,  zone = 71},
    [2]		=	{x = -567,   y = 0,  z =  64,   rot =  64,  zone = 71},
    [3]		=	{x = -488,   y = 0,  z = -64,   rot = 192,  zone = 71},
    [4]		=	{x = -487,   y = 0,  z =  64,   rot =  64,  zone = 71},
    [5]		=	{x = -568,   y = 0,  z = -64,   rot = 192,  zone = 71},
}
...
function onTrigger(player, target)
    ...
    --local rot2 = 1
   local zone = 71
   local loc_var = math.random(1,5)
   local p_loc_map = p_loc_coord[loc_var]
   local t_loc_map = t_loc_coord[loc_var]
   ...
   if (targ ~= nil and targ:getID() ~= player:getID()) then
        ...
        player:setPos(p_loc_map.x, p_loc_map.y, p_loc_map.z, p_loc_map.rot, p_loc_map.zone)
    	targ:setPos(t_loc_map.x, t_loc_map.y, t_loc_map.z, t_loc_map.rot, t_loc_map.zone)
